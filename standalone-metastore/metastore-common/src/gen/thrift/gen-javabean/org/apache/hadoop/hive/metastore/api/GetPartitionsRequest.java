            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.groupNames = new ArrayList<String>(_list1016.size);
                String _elem1017;
                for (int _i1018 = 0; _i1018 < _list1016.size; ++_i1018)
                {
                  _elem1017 = iprot.readString();
                  struct.groupNames.add(_elem1017);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.groupNames != null) {
        if (struct.isSetGroupNames()) {
          oprot.writeFieldBegin(GROUP_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter1019 : struct.groupNames)
            {
      ...
      if (struct.isSetGroupNames()) {
        {
          ...
          for (String _iter1020 : struct.groupNames)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.groupNames = new ArrayList<String>(_list1021.size);
          String _elem1022;
          for (int _i1023 = 0; _i1023 < _list1021.size; ++_i1023)
          {
            _elem1022 = iprot.readString();
            struct.groupNames.add(_elem1022);
          }
        }
        struct.setGroupNamesIsSet(true);
      }
