            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tblNames = new ArrayList<String>(_list880.size);
                String _elem881;
      ...
      if (struct.tblNames != null) {
        if (struct.isSetTblNames()) {
          oprot.writeFieldBegin(TBL_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter883 : struct.tblNames)
            {
      ...
      if (struct.isSetTblNames()) {
        {
          ...
          for (String _iter884 : struct.tblNames)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tblNames = new ArrayList<String>(_list885.size);
          String _elem886;
