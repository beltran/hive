            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionSpec = new ArrayList<PartitionSpec>(_list1008.size);
                PartitionSpec _elem1009;
                for (int _i1010 = 0; _i1010 < _list1008.size; ++_i1010)
                {
                  _elem1009 = new PartitionSpec();
                  _elem1009.read(iprot);
                  struct.partitionSpec.add(_elem1009);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPartitionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionSpec != null) {
        oprot.writeFieldBegin(PARTITION_SPEC_FIELD_DESC);
        {
          ...
          for (PartitionSpec _iter1011 : struct.partitionSpec)
          {
      ...
      if (struct.isSetPartitionSpec()) {
        {
          ...
          for (PartitionSpec _iter1012 : struct.partitionSpec)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionSpec = new ArrayList<PartitionSpec>(_list1013.size);
          PartitionSpec _elem1014;
          for (int _i1015 = 0; _i1015 < _list1013.size; ++_i1015)
          {
            _elem1014 = new PartitionSpec();
            _elem1014.read(iprot);
            struct.partitionSpec.add(_elem1014);
          }
        }
        struct.setPartitionSpecIsSet(true);
      }
