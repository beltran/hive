            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.values = new ArrayList<ClientCapability>(_list872.size);
                ClientCapability _elem873;
                for (int _i874 = 0; _i874 < _list872.size; ++_i874)
                {
                  _elem873 = org.apache.hadoop.hive.metastore.api.ClientCapability.findByValue(iprot.readI32());
                  struct.values.add(_elem873);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClientCapabilities struct) throws org.apache.thrift.TException {
      ...
      if (struct.values != null) {
        oprot.writeFieldBegin(VALUES_FIELD_DESC);
        {
          ...
          for (ClientCapability _iter875 : struct.values)
          {
            oprot.writeI32(_iter875.getValue());
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class ClientCapabilitiesTupleScheme extends TupleScheme<ClientCapabilities> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClientCapabilities struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ClientCapability _iter876 : struct.values)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClientCapabilities struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list877 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.values = new ArrayList<ClientCapability>(_list877.size);
        ClientCapability _elem878;
        for (int _i879 = 0; _i879 < _list877.size; ++_i879)
        {
          _elem878 = org.apache.hadoop.hive.metastore.api.ClientCapability.findByValue(iprot.readI32());
          struct.values.add(_elem878);
        }
      }
      struct.setValuesIsSet(true);
    }
