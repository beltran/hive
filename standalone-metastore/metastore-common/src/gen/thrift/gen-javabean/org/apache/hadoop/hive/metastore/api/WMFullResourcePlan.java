            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new ArrayList<WMPool>(_list896.size);
                WMPool _elem897;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mappings = new ArrayList<WMMapping>(_list899.size);
                WMMapping _elem900;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.triggers = new ArrayList<WMTrigger>(_list902.size);
                WMTrigger _elem903;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.poolTriggers = new ArrayList<WMPoolTrigger>(_list905.size);
                WMPoolTrigger _elem906;
  ...
  private static class WMFullResourcePlanTupleScheme extends TupleScheme<WMFullResourcePlan> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      struct.setPlanIsSet(true);
      {
        ...
        struct.pools = new ArrayList<WMPool>(_list916.size);
        WMPool _elem917;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.mappings = new ArrayList<WMMapping>(_list919.size);
          WMMapping _elem920;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.triggers = new ArrayList<WMTrigger>(_list922.size);
          WMTrigger _elem923;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.poolTriggers = new ArrayList<WMPoolTrigger>(_list925.size);
          WMPoolTrigger _elem926;
