            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new ArrayList<FieldSchema>(_list960.size);
                FieldSchema _elem961;
                for (int _i962 = 0; _i962 < _list960.size; ++_i962)
                {
                  _elem961 = new FieldSchema();
                  _elem961.read(iprot);
                  struct.cols.add(_elem961);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new ArrayList<FieldSchema>(_list965.size);
          FieldSchema _elem966;
          for (int _i967 = 0; _i967 < _list965.size; ++_i967)
          {
            _elem966 = new FieldSchema();
            _elem966.read(iprot);
            struct.cols.add(_elem966);
          }
        }
        struct.setColsIsSet(true);
      }
