...
public interface IMetaStoreClient {
   ...
   * @throws TException
   */
  void setCompactionHighestWriteid(CompactionInfoStruct cr, long highWatermark) throws TException;

  /**
   * Set the compaction id to the worker that's running it.
   * @param cqId compaction id.
   * @param workerId worker id.
   * @throws TException
   */
  void setRunAs(long cqId, String workerId) throws TException;
