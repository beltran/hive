...
public abstract class CompactorThread extends Thread implements Configurable {
  ...
  /**
   *
   * @param classname name of the class the extends {@link CompactorThread}
   * @return the class instantiated.
   * @throws Exception
   */
  public static CompactorThread instantiateThread(String classname) throws Exception {
    Class<?> c = Class.forName(classname);
    Object o = c.newInstance();
    if (CompactorThread.class.isAssignableFrom(o.getClass())) {
      return (CompactorThread) o;
    } else {
      String s = classname + " is not an instance of CompactorThread.";
      LOG.error(s);
